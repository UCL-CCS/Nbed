...
class subsystem():
    ...
    def Run_coupled_cluster_calc(self):
        ...
        high_level_scf.get_hcore = lambda *args,**kwargs: Get_embedded_Hamiltonian(high_level_scf, self.proj_pot)  # lambda here means doesn't matter what arguements you have, will run function above (fairly hacky solution)
        # Run Hartree-Fock
        high_level_scf.run()
