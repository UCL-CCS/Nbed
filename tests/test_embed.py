...
def test_embedding_hamiltonian() -> None:
    q_ham, e_classical = embedding_hamiltonian(geometry=str(water_filepath), active_atoms=2, basis="sto-3g", xc_functional='b3lyp', output='openfermion', convergence=1e-8)
